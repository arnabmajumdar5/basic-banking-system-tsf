...
const defaultUserNames = ["Rahim Mitra", "Akash Dubey", "Arunabha Das", "Shiladittya Mukherjee", "Soumabha Ghosh", "Anirban Pahari", "Ananya Das","Pratyush Das","Pritam Karmakar","Priya Sharma"];
const defaultUsersEmail = ["rm29@email.com", "ad55@email.com", "ad10@email.com", "sm9@email.com", "sg78@email.com", "ap08@email.com", "ad90@email.com","pd30@email.com","pk45@email.com","ps19@email.com"];
const defaultUsersAddress = ["Behala, Kolkata", "Newtown, Kolkata","Saltlake, Kolkata", "Niygipara, Dumdum", "Rakab Ganj, New Delhi","Shirdi, Maharashtra", "Borivali, Maharashtra","Powai, Maharashtra","Alipore, Kolkata","Khidirpur, Kolkata"];

const defaultUsers = [];
for (let i = 0; i < defaultUserNames.length; i++) {
    if (defaultUserNames[i] === "Ananya Das" || defaultUserNames[i] === "Priya Sharma") {
